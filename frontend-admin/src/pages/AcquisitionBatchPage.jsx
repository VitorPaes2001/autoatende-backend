...
function AutoAtendeInlinePilotExecution({ manifest, pilot, template, onPromotePilotResult = null, onPilotExecutionResult = null }) {
  ...
  const resolvePayloadComponentsForItem = (item) => {
    ...
    const defaultSendComponents = normalizeComponents(
      ...
      selectedTemplate?.defaultSendComponents ??
      selectedTemplate?.default_send_components
    );
...
<AutoAtendeInlinePilotExecution
  manifest={
    typeof preparedLotManifest !== 'undefined' ? preparedLotManifest :
    typeof frozenManifest !== 'undefined' ? frozenManifest :
    typeof preparedManifest !== 'undefined' ? preparedManifest :
    typeof lotManifest !== 'undefined' ? lotManifest :
  ...
  pilot={
    (
      (
        ...
        typeof manifest !== 'undefined' ? manifest :
        null
      )?.frozenPilotCandidate
    ) || (
      typeof preparedPilot !== 'undefined' ? preparedPilot :
      typeof frozenPilot !== 'undefined' ? frozenPilot :
      typeof preparedPilotBlock !== 'undefined' ? preparedPilotBlock :
      typeof pilotBlock !== 'undefined' ? pilotBlock :
      typeof pilotCandidate !== 'undefined' ? pilotCandidate :
      typeof nextPilotBlock !== 'undefined' ? nextPilotBlock :
      (
        (
          typeof preparedLotManifest !== 'undefined' ? preparedLotManifest :
          typeof frozenManifest !== 'undefined' ? frozenManifest :
  ...
  template={
    typeof selectedTemplate !== 'undefined' ? selectedTemplate :
    typeof templateSelection !== 'undefined' ? templateSelection :
    typeof chosenTemplate !== 'undefined' ? chosenTemplate :
    typeof currentTemplate !== 'undefined' ? currentTemplate :
    (
      (
        typeof preparedLotManifest !== 'undefined' ? preparedLotManifest :
        typeof frozenManifest !== 'undefined' ? frozenManifest :
