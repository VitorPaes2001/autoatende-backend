...
const [liveStates, setLiveStates] = useState({});
  ...
  }, [conversations, getConversationContact, selectedConversation, selectedConversationEffective, setConversations]);
...
const fetchConversations = useCallback(async (searchQuery = '', options = {}) => {
  ...
  }, [headers, session?.access_token, setConversations, syncLiveStatesForConversations]);
  ...
  const selectedConversationTimestamp = getConversationTimestamp(selectedConversation);
  ...
  }, [fetchMessages, selectedConversation?.id, selectedConversationTimestamp]);
