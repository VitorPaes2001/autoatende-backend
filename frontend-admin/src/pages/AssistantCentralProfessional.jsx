...
export default function AssistantCentralProfessional() {
  ...
  }, [compareBaseEntry, compareTargetEntry]);
      ...
      const draftData = await apiRequest('/draft', {
        ...
        body: JSON.stringify({
          ...
          publishContext: {
            ...
            referenceVersion: (() => {
              const candidate =
              typeof compareComparedEntry !== 'undefined' ? compareComparedEntry?.version :
              typeof compareReferenceEntry !== 'undefined' ? compareReferenceEntry?.version :
              typeof comparedEntry !== 'undefined' ? comparedEntry?.version :
              typeof referenceEntry !== 'undefined' ? referenceEntry?.version :
              typeof selectedComparedVersion !== 'undefined' ? selectedComparedVersion :
              typeof compareComparedVersion !== 'undefined' ? compareComparedVersion :
              null;
